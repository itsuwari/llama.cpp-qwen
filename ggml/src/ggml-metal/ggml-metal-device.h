...
bool ggml_metal_q8_soa_enabled(const struct ggml_tensor * op, int nxpsg);
struct ggml_metal_buffer_id ggml_metal_q8_soa_get(const struct ggml_tensor * w);
bool ggml_metal_f32_bf16_get(const struct ggml_tensor * w, struct ggml_metal_buffer_id * id);

#ifdef __cplusplus
}
#endif

int ggml_metal_q8_thin_mode(const struct ggml_tensor * op);
int ggml_metal_q8_split_k(const struct ggml_tensor * op);

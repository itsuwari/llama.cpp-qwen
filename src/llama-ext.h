...
// Experimental per-context MTP candidate IDs; count zero restores the full head.
LLAMA_API void llama_set_draft_vocab(struct llama_context * ctx, const llama_token * tokens, size_t count);
